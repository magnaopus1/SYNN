...
nodes:
  bootstrap_node:
    ...
    firewall:
      allow_ips:
        - "192.168.1.200"               # IPs allowed through the firewall for this node
      block_ips:
        - "192.168.1.50"                # IPs blocked by the firewall for this node
    p2p_network:
      enabled: true                     # P2P network enabled for this node
    qos:
      enabled: true                     # QoS enabled for this node
    routing:
      enabled: true                     # Routing enabled for this node
    sdn_controller:
      enabled: true                     # SDN controller enabled for this node
    server:
      enabled: true                     # Server is enabled for this node
  ...
  new_node_001:
    ...
    firewall:
      allow_ips:
        - "192.168.1.201"               # IPs allowed through the firewall for this node
      block_ips:
        - "192.168.1.51"                # IPs blocked by the firewall for this node
    p2p_network:
      enabled: true                     # P2P network enabled for this node
    qos:
      enabled: true                     # QoS enabled for this node
